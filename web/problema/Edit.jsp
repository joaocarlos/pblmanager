...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <ui:composition template="../template/portal_template.xhtml">
        <ui:define name="content">
            <h3>Novo Problema</h3>
            <h:form id="editarproblema">
                <div class="buttons">
                    <h:commandLink action="#{problema.edit}"  class="positive">
                    ...
                    <h:outputText value="    "/>
                    <h:commandLink action="${problema.edit2}">
                        <img src="#{request.contextPath}/template/images/save.png" alt=""/>Salvar
                        <f:param name="jsfcrud.currentProblema" value="${jsfcrud_class['controller.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][problema.problema][problema.converter].jsfcrud_invoke}"/>
                    </h:commandLink>
                    <h:outputText value="    "/>
                    <h:commandLink action="#{problema.listSetup}" class="negative" immediate="true">
                        ...
                        <div class="content_problema">
                            <a4j:region>
                                ...
                                <h:dataTable id="goalTable"
                                    ...
                                    <h:column>
                                        <f:facet name="header">
                                            <label style="display: block; width: 435px; border-bottom: solid 1px #e2e2e2;"></label>
                                        </f:facet>
                                        <h:outputText value="${item.objetivo}"/>
                                    </h:column>
                                    <h:column>
                                        <f:facet name="header">
                                            <label style="display: block; width: 100px; border-bottom: solid 1px #e2e2e2;"></label>
                                        </f:facet>
                                        <div class="buttons">
                            ...
                            <a4j:region>
                                ...
                                <h:dataTable id="resourceTable"
                                             ...
                                             var="item" border="0" cellpadding="0" cellspacing="2">
                                    <h:column>
                                        <f:facet name="header">
                                            <label style="display: block; width: 435px; border-bottom: solid 1px #e2e2e2;"></label>
                                        </f:facet>
