...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <ui:composition template="../template/portal_template.xhtml">
        ...
        <ui:define name="content">
            <h3>Listagem de Problemas</h3>
            <h:form id="listaProblemas">
                <br/>
                <h:dataTable value="#{problema.problemaItems}" var="item" id="dados"
                    ...
                    <h:column>
                        ...
                        <center>
                            ...
                            <span class="dcontexto">
                                <h:commandLink action="#{problema.editSetup}">
                            ...
                            <span class="dcontexto">
                                <h:outputLink value="#" id="link" rendered="#{(item.professorAutor.nome == professor.professorItems3) || professor.render}">
                                    ...
                                    <rich:componentControl for="panel" id="richApagar" attachTo="link" operation="show" event="onclick"/>
                                </h:outputLink>
                ...
                <div class="summaryButton">
                    <div class="buttons">
                        <h:commandLink action="#{problema.createSetup}" class="positive">
                            <img src="#{request.contextPath}/template/images/new_file.png" alt=""/>Novo Porblema
                        </h:commandLink>
                    </div>
                    <div class="clear"></div>
                </div>
